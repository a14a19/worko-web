    ...
    return (
        <div  style={{ padding: "revert", margin: "revert", fontSize: "revert",  }}>
            ...
            <p>
                ...
                Step 3: Click the "+ New Task" or a similar button to create a new task. <br />

                Step 4: Fill in the task details, including the task name, description, and priority. <br />
            ...
            <ul>
                ...
                <li>Adjusting due dates if needed, by editing the task details or using drag-and-drop features.</li>

                <li> Completing tasks on or before their deadlines to stay on top of your work.
                </li>
            </ul>
            <br />
