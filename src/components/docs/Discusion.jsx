    ...
    return (
        <div  style={{ padding: "revert", margin: "revert", fontSize: "revert",  }}>
            ...
            <p>Step 1: Log in to your Worko Management account. <br />
                ...
                Step 3: Click the "+ New Discussion" or a similar button to initiate a new discussion. <br />

                Step 4: Enter a title for your discussion to give it a clear and concise name. <br />

                Step 5: Add a description or content to provide context for your discussion. <br />

                Step 6: Optionally, select relevant tags or categories to categorize your discussion. <br />
