    ...
    return (
        <div  style={{ padding: "revert", margin: "revert", fontSize: "revert",  }}>
            ...
            <p>To change the appearance of Worko, follow these steps: <br />
                ...
                Step 3: Look for options related to changing the theme or color scheme. <br />

                Step 4: Select your preferred theme or customize colors as desired. <br />
                ...
                This code sends a request to the Worko API to update the theme to "dark." <br />

                <br />

                By following these steps or using the provided code block, you can customize the appearance and settings of your Worko platform to match your personal preferences.
...
export default CustomizingWorko