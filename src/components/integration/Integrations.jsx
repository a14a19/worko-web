...
export default function Integrations(){
    return(
        <>
    {/* Hero Section Starts  */}
      <div className="relative hero max-w-[1140px] mx-auto">
          ...
          <div className="communication-container flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-6 mx-auto tables-columns">
              <div className="outer-div flex flex-cols justify-start">
                ...
                <div className="mt-2">
                  <p className="p text-left text-gray-500 font-semibold">
                    Worko Medium integration enhances content management.
                  </p>
                </div>
              </div>
              <div className="outer-div">
                ...
                <div className="mt-2">
                  <p className="p text-left text-gray-500 font-semibold">
                    Worko Patreon integration provides strong support.
                  </p>
                </div>
              </div>
              <div className="outer-div">
          ...
          <div className="communication-container flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-6 mx-auto tables-columns">
              <div className="outer-div flex flex-cols justify-start">
                ...
                <div className="mt-2">
                  <p className="p text-left text-gray-500 font-semibold">
                    Worko integration with Coda empowers efficient project.
                  </p>
                </div>
              </div>
              <div className="outer-div">
                ...
                <div className="mt-2">
                  <p className="p text-left text-gray-500 font-semibold">
                    Worko Dev.to integration streamlines content management
                  </p>
                </div>
              </div>
              <div className="outer-div">
              ...
              <div className="outer-div">
                ...
                <div className="mt-2">
                  <p className="p text-left text-gray-500 font-semibold">
                    Optimize DevOps workflows with GitLabs comprehensive.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="communication-container flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-6 mx-auto tables-columns">
              <div className="outer-div flex flex-cols justify-start">
                ...
                <div className="mt-2">
                  <p className="p text-left text-gray-500 font-semibold">
                    Worko and Telegram integrate seamlessly to enhance task efficiecy.
                  </p>
                </div>
              </div>
              <div className="outer-div">
