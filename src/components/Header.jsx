...
function Header() {
    ...
    return (
        <header className="bg-[#87878713] backdrop-blur max-w-[1140px] sticky top-0 rounded-full z-20 mx-auto mt-2  shadow-[inset_0px_0px_5px_rgba(225,225,225,0.1)]">
            ...
            <Dialog as="div" className="lg:hidden relative" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
                <div className="fixed inset-0 z-30" />
                <Dialog.Panel className="absolute right-5 z-30 w-full overflow-y-auto bg-[#121218] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10  rounded-3xl">
